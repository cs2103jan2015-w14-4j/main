...
public class TaskManager implements TaskManagerInterface {
    ...
    private static final String MSG_ERR_OVERDUE = "Sorry, your task is still overdue.";
    ...
    private ArrayList<Task> editATask(Task taskToEdit, String[] inputs) {
        ...
        if (!isTaskStatusOverdue(taskToEdit) && !isTaskComplete(taskToEdit) && isTaskOverdue(taskToEdit)) {
            throw new IllegalArgumentException(MSG_ERR_OVERDUE);
        }
